...
import { getPostBySlug, getAdjacentPosts, type BlogSection } from "@/data/blog-posts";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-mono text-2xl font-bold text-text mb-4">
            Post not found
          </h1>
          <Link
            href="/blog"
            className="font-mono text-sm text-prism-purple hover:text-prism-purple/80 underline"
          >
            Back to blog
          </Link>
        </div>
